...
# - check against the definitive list of @-cmds; we still miss (amongst others):
...
class TexinfoParser:
	...
	def open_cite(self): self.write('<CITE><HP1>')
	def close_cite(self): self.write('</HP1></CITE>')
	...
	def open_dfn(self): self.write('<DFN><HP1>')
	def close_dfn(self): self.write('</HP1></DFN>')

	def open_emph(self): self.write('<HP1>')
	def close_emph(self): self.write('</HP1>')
	...
	def open_strong(self): self.write('<HP2>')
	def close_strong(self): self.write('</HP2>')
