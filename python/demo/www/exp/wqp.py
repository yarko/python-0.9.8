...
# Regular expression used by the tokenizer.
#
tokenpat = '[()#]\|[^()#"; \t\n\r\f]+\|"\(\\\\.\|[^\\"]\)*"'
...
#import sys
#sys.stdin = open('/ufs/guido/wais-questions/Fetch', 'r')
#testparser()
